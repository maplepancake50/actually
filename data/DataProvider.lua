    ...
    delayFrame:SetScript("OnUpdate", function(self, dt)
        ...
        if elapsed >= 10 then
            ...
            if DEFAULT_CHAT_FRAME then
                DEFAULT_CHAT_FRAME:AddMessage("|cff00ccff[actually]|r Your addon is out of date and may not work correctly. Please update to the latest version or contact |cffffcc00Bolty|r for assistance.", 1, 0.82, 0)
            end
        end
    end)
end
